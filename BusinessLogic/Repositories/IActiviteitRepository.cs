...
namespace BusinessLogic.Repositories
{
    public interface IActiviteitRepository
    {
        ...
        System.Collections.Generic.List<Models.OmgevingsBoek_Models.Activiteit> get50FromSortNameAZ(int from, string search);
        System.Collections.Generic.List<Models.OmgevingsBoek_Models.Activiteit> get50FromSortNameZA(int from, string search);
        System.Collections.Generic.List<Models.OmgevingsBoek_Models.Activiteit> get50FromSortPoiAZ(int from, string search);
        System.Collections.Generic.List<Models.OmgevingsBoek_Models.Activiteit> get50FromSortPoiZA(int from, string search);
        System.Collections.Generic.List<Models.OmgevingsBoek_Models.Activiteit> get50FromSortUserAZ(int from, string search);
        System.Collections.Generic.List<Models.OmgevingsBoek_Models.Activiteit> get50FromSortUserZA(int from, string search);
