...
namespace BusinessLogic.Services
{
    public interface IBoekService
    {
        ...
        System.Collections.Generic.List<Models.MVC_Models.ApplicationUser> GetUserNext30SortAZ(int from, string search, bool DisplayDeleted);
        System.Collections.Generic.List<Models.MVC_Models.ApplicationUser> GetUserNext30SortZA(int from, string search, bool DisplayDeleted);
